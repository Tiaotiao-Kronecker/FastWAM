...
export RUN_ID="${RUN_ID:-a1_4_full_mix_from070k_to70300_smoke_h2002_4gpu_retry1_20260613_1420}"
...
exec accelerate launch \
  ...
  "wandb.name=libero_one_step_meanflow_a1_mix_lora_eqanchor_2cam224_5e-5" \
  ...
  wandb.enabled=false \
  wandb.name=a1_4_full_mix_from070k_to70300_smoke_h2002_4gpu \
